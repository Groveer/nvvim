...
return {
  ...
  opts = {
    ...
    dashboard = require("nvvim.plugins.snacks.dashboard"),
  ...
  keys = {
    ...
    -- LSP: see lua/nvvim/configs/lsp.lua for lsp mappings
    ...
    -- { "<A-d>",      function() Snacks.terminal() end, desc = "Toggle Terminal" },
